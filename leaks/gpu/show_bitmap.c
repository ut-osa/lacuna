/***********
  testbitmap program from the SDL testing suit, adopted to show the bitmap
  dumped from the X. The bitmap should be provided in stdin
 */
...
int main(int argc, char *argv[])
{
	...
	if ( (screen=SDL_SetVideoMode(1600,1200,video_bpp,videoflags)) == NULL ) {
	...
	char* largebuf=malloc(1600*1200*4);
	if (largebuf) fprintf(stderr,"Failed to allocate largebuf\n");
	
        int read=fread(largebuf,1,1600*1200*4,stdin);
                if (read<1600*1200*4) {
