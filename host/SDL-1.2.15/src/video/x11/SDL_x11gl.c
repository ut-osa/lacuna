...
int X11_GL_CreateContext_mark(){
	X11_GL_GetVisual(current_video);
	return X11_GL_CreateContext(current_video);
}
...
void X11_GL_SwapBuffers_mark(void){
	X11_GL_SwapBuffers(current_video);
}
