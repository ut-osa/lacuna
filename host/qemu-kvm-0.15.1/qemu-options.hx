...
HXCOMM Only allow i386 for now
DEF("priv-input", HAS_ARG, QEMU_OPTION_priv_input,
    "-priv-input     configure a private input device\n",
    QEMU_ARCH_I386)
DEF("priv-switch-bench", 0, QEMU_OPTION_priv_switch_bench,
    "-priv-switch-bench\n"
    "                time input switching\n",
    QEMU_ARCH_I386)
#endif
#ifdef CONFIG_PRIV_NET
DEF("priv-net-num", HAS_ARG, QEMU_OPTION_priv_net_num,
    "-priv-net-num <num>    configure a VM with a certain \"number\" to\n"
    "                       differentiate it from other VMs for network\n"
    "                       purposes\n",
    QEMU_ARCH_I386)
#endif
#ifdef CONFIG_PRIV_SOUND
DEF("priv-sound", 0, QEMU_OPTION_priv_sound,
    "-priv-sound            turn on private sound\n",
    QEMU_ARCH_I386)
#endif
#ifdef CONFIG_PRIV_DIFF
DEF("priv-diff", 0, QEMU_OPTION_priv_diff,
    "-priv-diff             encrypt metadata of diff files\n",
    QEMU_ARCH_I386)
#endif
